...
const TrendingNews = ({ article }) => {
  ...
  return (
    <div className='flex flex-col p-5 gap-4 relative dark:text-gray-200'>
      
        <h1 className='text-3xl font-bold'>Trending News</h1>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 max-w-7xl mx-auto cursor-pointer'>
