  ...
  return (
    <div className='flex flex-col lg:flex-row lg:p-5 dark:text-gray-300'>
        ...
        className='relative cursor-pointer group overflow-hidden w-full'>
                ...
                <h1 className='absolute inset-0 p-5 text-4xl md:text-6xl md:py-20 text-gray-100 dark:text-gray-200 font-bold'>Featured News</h1>
            ...
            <div className='absolute bottom-0 md:bottom-10 lg:bottom-0 text-white p-5 flex flex-col gap-2 md:gap-6'>
                ...
                <h1 className='text-2xl md:text-5xl font-bold md:leading-15 dark:text-gray-200'>OpenAI's first hardware device is reportedly a screenless speaker that can move</h1>
