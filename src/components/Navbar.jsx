...
const Navbar = () => {
  ...
  return (
    <div  className='flex justify-between items-center p-5 bg-[#dc2626] dark:bg-red-800 text-[#f8fafc] font-medium h-15 sticky top-0 z-50 shadow-lg'>
      <Link to='/'>
      ...
      <div className="hidden md:flex gap-5 items-center dark:text-gray-200">
        ...
        {/* Dark mode button */}
          ...
          >
            {theme === "light" ? <Moon /> : <Sun className="text-amber-300" />}
          </button>
      ...
      <div className="md:hidden flex relative gap-3">
        ...
        {isOpen && (
          ...
          className="fixed h-screen w-[60%] right-0 top-15 flex flex-col gap-5 items-center py-8 bg-[#dc2626] dark:bg-red-800 dark:text-gray-200">
            {links.map((link) => (
